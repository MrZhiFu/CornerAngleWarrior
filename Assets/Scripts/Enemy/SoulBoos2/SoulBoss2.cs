...
public class SoulBoss2 : MonoBehaviour {

    private Transform playerTrs;//需要跟踪的主角位置
    private PlayerATKAndDamage playerATKAndDamage;//主角的攻击和受伤脚本
    private CharacterController cc;//Boss2的角色控制器
    private Animator animator;//动画控制器

    public float attackDistance = 2.0f;//Boss2的攻击距离
    public float moveSpeed = 2.0f;//Boos2的移动速度
